...
class Dbapi(object):
    ...
    def __init__(self,session,package,table,factorycls,linkstr="mysql",columns=None,fullsearch_clmns=None):
        ...
        :package the package where mapper table class in here. for example:'xtcs.policy.mapping_db',
        ...
        :linkstr db engine link string,
        :columns expect return table columns,
